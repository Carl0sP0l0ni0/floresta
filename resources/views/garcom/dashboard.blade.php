    ...
    <main class="container-fluid">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                <div class="me-auto">
                                    ...
                                    <span class="text-muted">{{ ($table->busy)?'Ocupada':'Libre' }}</span>
                                </div>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm d-none container" id="manage-table">
            ...
            <div class="col-md-7 mx-auto px-3 border-bottom">
                ...
                <div id="load-error" class="mb-3 d-none">
                    <div class="alert alert-danger w-100 text-center">No se pueden cargar los detalles, intenta de nuevo más tarde!
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Adicionar produtos a la mesa #<span id="add-table-id"></span></h5>
                    ...
                    <div class="modal-body">
                        <form id="form-product" novalidate>
                            <div class="col-9 mx-auto">
                                <ul class="list-group mb-3">
                                    <div id="products-add">
                                        <li class="list-group-item text-muted text-center">Todavía no hay productos para
                                            ¡Agregar a la mesa!
                                        </li>
                                    </div>
                                    <li class="list-group-item d-flex justify-content-between">
                                        <span>Total</span>
                                        <strong id="total-add-products">S/ 0,00</strong>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-11 mx-auto d-flex justify-content-between">
                                <div class="col-9 d-flex justify-content-between">
                                    <div class="col-8">
                                        <label for="add-product-id" class="visually-hidden">Productos</label>
                                        <select class="form-select" id="add-product-id" required>
                                            <option disabled selected value="" class="d-none">Seleccione ...</option>
                                    ...
                                    <div class="col-3">
                                        <label for="add-product-quantity" class="visually-hidden">cantidad</label>
        ...
        <div class="modal fade" tabindex="-1" id="close-bill">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> Cerrar cuenta de mesa #<span id="close-table-id"></span></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="col-9 mx-auto">
                                <label for="quantity-people-table" class="form-label">
                                    ¿Cuántas personas pagarán?
                                </label>
                                <div class="input-group">
                                    <input type="number" min="1" required id="quantity-people-table" name="value"
                                           class="form-control">
                                    <span class="input-group-text">Personas(s)</span>
                                    <div class="invalid-feedback text-center">
                                        El número de personas es obligatorio y no puede ser inferior a 1,
                                        ¡No más grande que la capacidad de la mesa!
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" tabindex="-1" id="pay-bill">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">factura de mesa de pago #<span id="pay-table-id"></span></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="col-9 mx-auto">
                                <div class="display-6 text-center">
                                    <span id="value-pay"></span><small class="text-muted fw-light">/persona</small>
                                </div>
